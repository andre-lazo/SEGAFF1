    ...
    <div class="modal-dialog modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header bg-dark">
          <h5 class="modal-title text-white " id="exampleModalLabel"><b>EDICION DE RESIDENTE</b></h5>
        ...
        <div class="modal-body">
            ...
            <form  action="{{ route('residente.upload') }}" class="dropzone" id="my-awesome-dropzone" method="POST">
                @method('POST')
                {{ csrf_field() }}
              ...
              <form action="{{ route('residente.store') }}" method="POST"  >
                @method('POST')
                @csrf
               <input type="hidden" name="imagen_nombre" id="imagen_nombre">
